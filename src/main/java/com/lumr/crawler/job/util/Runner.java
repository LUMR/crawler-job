...
public class Runner {
    ...
    public static void runExample(Class clazz) {
        runExample(WEB_JAVA_DIR, clazz, new VertxOptions().setClustered(false), null);
    }

    public static void runExample(Class clazz, DeploymentOptions options) {
        runExample(WEB_JAVA_DIR, clazz, new VertxOptions().setClustered(false), options);
    }

    private static void runExample(String exampleDir, Class clazz, VertxOptions options, DeploymentOptions
        deploymentOptions) {
